...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/rapid-rain-629d
```

A live public deployment of this template is available at [https://rapid-rain-629d.templates.workers.dev](https://rapid-rain-629d.templates.workers.dev)
